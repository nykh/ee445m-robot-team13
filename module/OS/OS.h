...
#define __Performance_Measurement__  // Main option, disables this will remove all performance measurement
	...
	#define __Critical_Interval_Measurement__
...
#ifdef DEPRECATE
/* Deprecated, calls OS_AddSW1Task */ int OS_AddButtonTask(void(*task)(void), unsigned long priority);
#endif
...
/********************************* Performance Measurement ************************************/
	...
	// Duration is specified in unit of 10 ms
